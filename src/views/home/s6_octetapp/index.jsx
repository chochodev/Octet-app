...
const OctetApp = () => {
  ...
  return (
    <div className={`relative flex flex-col gap-[4rem] items-center pt-[3rem] sm:pt-[4rem] md:pt-[5rem] w-full min-h-[50rem] ${padding_style} `}>
      <div className="flex flex-col w-full max-w-[36.875rem]">
        <div>
        ...
        <div className="flex">
          <div className="flex">
            <h2>87%</h2>
            <p className="text">current status until release</p>
          </div>
          <div className="flex">
            <h2>25k</h2>
            <p className="text">our App pre-bookers</p>
          </div>
        </div>
        
      </div>
      <img src="./assets/images/phone.png" alt="PHONE" className='min-w-[50%] object-contain' />
    </div>
  )
}
